...
This page covers building HoverNet from source, its packaging, and its CI pipelines. For what the game is and how to install/play it, see the [README](../README.md).

The repository contains the native Windows client, an SDL2 Linux client, and the authoritative multiplayer race server.
...
- [Track compiler format](track-format.md)
